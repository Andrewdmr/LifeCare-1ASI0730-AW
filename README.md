    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 20px; border: 1px solid #ddd; vertical-align: middle; text-align: left;">
          ...
          <i>Estoy cursando el quinto ciclo de mi carrera. A lo largo de mi experiencia aprendí muchas cosas como ser una persona proactiva, perseverante y responsable. Mediante mi conocimiento sé que puedo aportar más de mis capacidades para presentar un buen proyecto en equipo.
</i>
        </td>
